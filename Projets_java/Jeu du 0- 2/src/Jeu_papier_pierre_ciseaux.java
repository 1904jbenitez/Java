...
public class Jeu_papier_pierre_ciseaux {
	...
	public static void main(String[] args) {
		...
		do
		{
			...
			{
				System.out.println("Vous avez gagné, votre compteur a été incrementé d'un point!");
				compteur1++;
			}
			...
			{
				System.out.println("Vous avez perdue, le compteur de l'ordinateur a été incrementé d'un point!");
				compteur2++;
			}
			else if (nbUser < (nbMachine - 2))
			{
